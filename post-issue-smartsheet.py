...
while current_issue_num <= triggered_issue_num:
    ...
    response = requests.get(
        f'https://api.github.com/repos/SeattleColleges/shift-app-expo/issues/{current_issue_num}',
        headers={
    ...
    smartsheet_response = requests.post(
        ...
        json={
            ...
            'cells': [
                {
                    'columnId':  2188750605209476,  # "Task Name"
                    'value': title
                },
                {
                    'columnId': 6692350232579972,  # "Repo"
                    'value': repo_url[45:]
                },
                {
                    'columnId': 8944150046265220,  # "Assigned To"
                    'value': assignee
                },
                {
                    'columnId': 42503907790724,  # "Index"
                    'value': index
                }
            ]
        }
